-- Mantiene la firma previa para consumidores existentes y añade la edición
-- atómica de concepto_id para el administrador actual.
...
revoke all on function public.actualizar_pregunta_admin(uuid, uuid, text, text, text, text, text, text, text, uuid, text, uuid, text, uuid, text, uuid, text, uuid) from public, anon;
grant execute on function public.actualizar_pregunta_admin(uuid, uuid, text, text, text, text, text, text, text, uuid, text, uuid, text, uuid, text, uuid, text, uuid) to authenticated;
